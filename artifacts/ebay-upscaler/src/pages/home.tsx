    ...
    <div className="flex flex-col">
      ...
      <section className="relative px-4 py-20 sm:py-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {/* Stats */}
          {stats && typeof stats === "object" && typeof stats.totalProcessed === "number" && (
            <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
              {[
                { label: "Images Processed", value: (stats.totalProcessed ?? 0).toLocaleString() },
                { label: "Upscaled", value: (stats.totalUpscaled ?? 0).toLocaleString() },
                { label: "Converted", value: (stats.totalConverted ?? 0).toLocaleString() },
                { label: "Banners Created", value: (stats.totalBannersCreated ?? 0).toLocaleString() },
              ].map((s) => (
